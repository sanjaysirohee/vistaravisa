...
?>
 <main>
                    ...
                    <div class="col-xl-6">
                        <div class="breadcrumb-wrap">
                            <nav class="breadcrumb">
                                ...
                                <span property="itemListElement" typeof="ListItem">Become a Partner</span>
                            </nav>
                        </div>
                    </div>
                </div>
    ...
    About Area
    ==============================-->
        <section class="about-area-3 pb-120 pt-60 overflow-hidden">
            <div class="container">
                        ...
                        <div class="col-xl-5">
                            <div class="about-thumb3-1">
                                <div class="img1 image-anim">
                                    <img src="aa/Untitled design (18).png" alt="img">
                                </div>
                                 <!--jump image-anim-->
                                <div class="img2">
                                    <div class="thumb">
                                        <img src="aa/Untitled design (19).png" alt="img">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="about-grid-wrap">
                                <div class="about-grid-card style2">
                                    ...
                                    <div class="card-details">
                                        <h4 class="box-title">Education consultants</h4>
                                        <!--<p class="box-text">30 days regular shipping</p>-->
                                    </div>
                                </div>
                                <div class="about-grid-card style2">
                                    <div class="box-icon">
                                    ...
                                    <div class="card-details">
                                        <h4 class="box-title">Recruitment agencies</h4>
                                        <!--<p class="box-text">24 hour fast shipping</p>-->
                                    </div>
                                </div>
                            </div>
                        </div>
       ...
       <section class="wcu-area-1 pt-60 pb-120"  data-background="assets/img/bg/feature-bg1-1.png">
            <div class="container">
                ...
                <div class="row gy-40">
                    <div class="col-xl-3 col-md-6">
                        <div class="wcu-card">
                            ...
                            <h4 class="box-title">Trusted Brand Association</h4>
                            <p class="box-text">Work with a professional and transparent visa & immigration consultancy.
                     ...
                     <div class="col-xl-3 col-md-6">
                        <div class="wcu-card">
                            ...
                            <h4 class="box-title">Business Growth Opportunities
</h4>
                            <p class="box-text">Expand your service offerings without operational complexity as we handle the  backend process.
                     ...
                     <div class="col-xl-3 col-md-6">
                        <div class="wcu-card">
                            ...
                            <h4 class="box-title">Expert Back-End Support


</h4>
                            <p class="box-text">Our experienced team handles documentation, processing, and compliance.
                     ...
                     <div class="col-xl-3 col-md-6">
                        <div class="wcu-card">
                            ...
                            <h4 class="box-title">Multiple Service Categories

</h4>
                            <p class="box-text">Offer Visa, Immigration, Air Ticket, and Hotel Booking services under one partnership.
