...
<head>
    ...
    <link rel="stylesheet" href="assets/css/style.css"><!-- Meta Pixel Code --><script>!function(f,b,e,v,n,t,s){if(f.fbq)return;n=f.fbq=function(){n.callMethod?n.callMethod.apply(n,arguments):n.queue.push(arguments)};if(!f._fbq)f._fbq=n;n.push=n;n.loaded=!0;n.version='2.0';n.queue=[];t=b.createElement(e);t.async=!0;t.src=v;s=b.getElementsByTagName(e)[0];s.parentNode.insertBefore(t,s)}(window, document,'script','https://connect.facebook.net/en_US/fbevents.js');fbq('init', '1406527147364439');fbq('track', 'PageView');</script><noscript><img height="1" width="1" style="display:none"src="https://www.facebook.com/tr?id=1406527147364439&ev=PageView&noscript=1"/></noscript><!-- End Meta Pixel Code -->
</head>
    ...
    <div id="preloader" class="white-bg">
        <div id="loader" class="loader">
            <div class="loader-container">
                <div class="loader-icon"><img src="assets/img/logo/84885e10-3981-41b3-bfc4-1e64ff9bc17b.png" alt="Preloader"></div>
            </div>
        </div>
    </div>
    <!--Preloader-end -->
                        ...
                        <ul class="tg-header__top-right list-wrap">
                            <li class="tg-header__top-social">
                                <ul class="list-wrap">
                                    ...
                                    <li>
                                        <a href="https://twitter.com" class="d-flex align-items-center" target="_blank">
                                    ...
                                    <li><a href="https://www.fa-linkedin.com/" target="_blank"><i class="fab fa-linkedin-in me-2"></i>Linkedin</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
...
"></a>
                                ...
                                <div class="info-card-wrap">
                                    ...
                                    <div class="info-card">
                                        ...
                                        <div class="info-card_content">
                                            ...
                                            <a href="mailto:info@vizabridgeglobal.com" class="info-card_link">info@vizabridgeglobal.com</a>
                                        </div>
                                    </div>
                                    <div class="info-card">
                                        <div class="info-card_icon">
                                        ...
                                        <div class="info-card_content">
                                            <p class="info-card_text"> Address</p>
                                            <p class="info-card_link">Sector 63, Noida, UP</p>
                                        </div>
                                    </div>
                                </div>
                            </nav>
                        ...
                        <div class="tgmenu__wrap">
                            <nav class="tgmenu__nav">
                                <div class="logo d-lg-none d-block">
                                    <a href="index.php"><img src="assets/img/logo/84885e10-3981-41b3-bfc4-1e64ff9bc17b.png" alt="Logo"></a>
                                </div>
                                <div class="tgmenu__navbar-wrap tgmenu__main-menu d-none d-lg-flex">
                                    <ul class="navigation">
                                        ...
                                        <li class="menu-item-has-children"><a href="service.php">Services</a>
                                            <ul class="sub-menu">
                                                <li><a href="visa_services.php">Visa </a></li>
                                                <li><a href="Immigration_Services.php">Immigration </a></li>
                                                <li><a href="AirTickets_Services.php">Air Tickets </a></li>
                                                <li><a href="HotelBookings_Services.php">	Hotel Bookings</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="becomeapartner.php">Become a Partner 	</a>
                                ...
                                <div class="tgmenu__action d-none d-lg-block">
                                    <a href="javascript:void(0)" class="btn btn-two menu-tigger">
                                        <span class="btn-text" data-text="Explore Visa Services"></span>
                                    </a>
                                </div>
        ...
        <div class="tgmobile__menu">
            <nav class="tgmobile__menu-box">
                ...
                <div class="nav-logo">
                    <a href="index.html"><img src="assets/img/logo/84885e10-3981-41b3-bfc4-1e64ff9bc17b.png" alt="Logo"></a>
                </div>
                ...
                <div class="tgmobile__menu-bottom">
                    <div class="contact-info">
                        <ul class="list-wrap">
                            <li>Mail: <a href="mailto:info@vizabridgeglobal.com">info@vizabridgeglobal.com</a></li>
                    ...
                    <div class="col-lg-6">
                        <div class="appointment-form-wrap">
                            <div class="section__title mb-30">
                                <h4 class="title">Explore Visa Services</h4>
                            </div>
