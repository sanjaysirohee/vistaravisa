...
<style>
  ...
  <main>
    ...
    About Area
    ==============================-->
        <section class="about-area-2 pt-60 pb-60 overflow-hidden">
            <div class="container">
                            ...
                            <div class="about-thumb2-1">
                                <div class="img1">
                                    <div class="thumb image-anim">
                                        <img src="assets/img/bg/Untitled design.png" alt="img">
                                    </div>
                                </div>
                                <div class="img2">
                                    <div class="thumb image-anim">
                                        <img src="assets/img/bg/Untitled design (1).png" alt="img">
                                    </div>
                                </div>
                            ...
                            <div class="checklist-wrap">
                                <ul class="list-wrap">
                                    <li>
                                        ...
                                        </span> Your Global Mobility Partner
                                    </li>
                                    <li>
                                        <span class="icon">
                                            <i class="fas fa-check-circle"></i>
                                        </span> Expert Guidance at Every Step
                                    </li>
                                    <li>
                                        <span class="icon">
                                            <i class="fas fa-check-circle"></i>
                                        </span> Personalized Visa Solutions
                                    </li>
                                     <li>
                                        <span class="icon">
                                            <i class="fas fa-check-circle"></i>
                                        </span> Complete Travel Support
                                    </li>
                                    <li>
                                        <span class="icon">
                                            <i class="fas fa-check-circle"></i>
                                        </span> Transparent & Reliable Process
                                    </li>
                                    
                                    <li>
                                        <span class="icon">
                                            <i class="fas fa-check-circle"></i>
                                        </span> Client-Focused Approach
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="row gy-30 justify-content-center">
                        <div class="col-lg-6 col-md-6">
                            <div class="feature-card">
                                <div class="box-icon">
                                    <img src="aa/3891726.png" style="width:60px;">
                                  
                                </div>
                                <h3 class="box-title"><a href="#">Our Mission</a></h3>
                                <p class="box-text">To empower individuals and families with reliable visa and immigration solutions that open doors to global opportunities while ensuring peace of mind at every step.</p>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="feature-card">
                                <div class="box-icon">
                                      <img src="aa/2421304.png" style="width:60px;">
                                </div>
                                <h3 class="box-title"><a href="#">Our Vision</a></h3>
                                <p class="box-text">To become a trusted global partner in international mobility, known for integrity, expertise, and successful outcomes.</p>
                            </div>
                        </div>
    ...
    Goal Area
    ==============================-->
        <section class="goal-area-1 pt-60 pb-60 overflow-hidden" data-background="assets/img/bg/feature-bg1-1.png">
            <div class="container">
                    ...
                    <div class="col-xl-6">
                        <div class="goal-thumb1-1 image-anim">
                            ...
                            <div class="thumb" data-mask-src="assets/img/others/goal-img-mask1-1.png">
                                <img src="aa/Untitled design (3).png" alt="img">
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6">
                        <div class="section__title mb-50">
                            ...
                            <h2 class="title text-anim2">Our Values</h2>
                        </div>
                        <div class="goal-grid-card">
                            ...
                            <div class="card-details">
                                <h4 class="box-title">Excellence</h4>
                                <p class="box-text">We are committed to delivering the highest standards of service, ensuring accuracy, efficiency, and professionalism in everything we do.</p>
                            </div>
                        </div>
                        <div class="goal-grid-card">
                            <div class="box-icon">
                            ...
                            <div class="card-details">
                                ...
                                <p class="box-text">Honesty and transparency are at the heart of our operations. We build trust with our clients by providing reliable and truthful guidance.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row gy-30 justify-content-center">
                    <div class="col-lg-3 col-md-6">
                        <div class="counter-card">
                            <h3 class="counter-card_title"><span class="counter-number">1000</span>+</h3>
                            <p class="counter-card_subtitle">Immigration</p>
                            <p class="counter-card_text">Absolute transparency at every stage — from eligibility assessment to documentation and final submission — ensuring you clearly understand every requirement.
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="counter-card">
                            <h3 class="counter-card_title"><span class="counter-number">150</span>+</h3>
                            <p class="counter-card_subtitle">Students</p>
                            <p class="counter-card_text">Trusted study abroad consultants helping students secure admissions and visas across top global destinations with clarity and confidence.
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="counter-card">
                            <h3 class="counter-card_title"><span class="counter-number">50</span>+</h3>
                            <p class="counter-card_subtitle">Universities</p>
                            <p class="counter-card_text">A strong bridge between students and reputed international universities — coordinating admissions, communication, and execution seamlessly.
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="counter-card">
                            <h3 class="counter-card_title"><span class="counter-number">30</span>+</h3>
                            <p class="counter-card_subtitle">Country</p>
                            <p class="counter-card_text">Policy-driven, compliant, and strategic visa solutions tailored to each client’s profile, adapting to regulatory changes with precision.
